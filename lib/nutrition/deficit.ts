...
/**
 * Sum the activity-adjusted deficit across logged days in [start, end]. Each
 * day's maintenance is trimmed by (stepBaseline - steps) * 0.04 * (weightKg/70)
 * for days under the baseline (only ever lowers).
 */
