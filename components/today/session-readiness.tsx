...
export function SessionReadiness({
  ...
  function onSave() {
    startTransition(async () => {
      ...
      if (res.ok) {
        toast.success('Systemic recovery saved.')
        setExpanded(false)
      } else {
        ...
        <CardContent className="flex items-center justify-between gap-3 p-3.5">
          <div className="flex items-center gap-3">
            ...
            <div className="font-mono text-sm tabular-nums">
              <span className="text-muted">Systemic recovery </span>
      ...
      <CardContent className="space-y-4 p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-0.5">
            <h2 className="text-sm font-semibold">Systemic fatigue</h2>
            <p className="text-xs text-muted">
              One rating for the whole session — how recovered vs. beat-up you feel
              from prior training. Per-muscle soreness is logged on each exercise.
            </p>
          </div>
        </div>
        ...
        <Rating
          ...
          hint="10 = fully recovered & fresh · 1 = wiped out / heavy systemic fatigue."
          value={recovery}
